...
echo ""
echo -e "  ${BLUE}1. Generate keys:${NC}"
echo -e "     ${GREEN}cd back && npx tsx src/scripts/generate-keys.ts${NC}"
echo ""
echo -e "  ${BLUE}2. Fund your platform wallet:${NC}"
echo -e "     ${GREEN}cd back && npx tsx src/scripts/fund-platform.ts${NC}"
echo ""
echo -e "  ${BLUE}3. Start all services with Docker:${NC}"
