...
echo -e "You'll need to fund the platform wallet before creating prescriptions."
echo -e "Run: ${GREEN}cd back && npx tsx src/scripts/fund-platform.ts${NC} for funding instructions."
echo ""
