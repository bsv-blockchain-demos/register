...
import { VCRecord } from './types.js'
import { Base64String } from '@bsv/sdk'
import { LookupFormula } from '@bsv/overlay'

// Implements a Lookup Storage Manager for VC tokens
export class VCStorageManager {
  private readonly records: Collection<VCRecord>
  ...
  constructor(private readonly db: Db) {
    this.records = db.collection<VCRecord>('vcRecords')
